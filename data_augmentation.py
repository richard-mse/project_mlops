...
# Nombre d'images cible par dossier
...
for folder_name in os.listdir(base_dir):
    ...
    if os.path.isdir(folder_path):
        ...
        # Copier les images existantes dans le dossier de sortie
        ...
        if images_to_generate > 0:
            print(f"Génération de {images_to_generate} images pour {folder_name}")
            current_image_index = 0  # Pour parcourir les images en rotation
            
            # Ajouter des images augmentées pour atteindre le nombre cible
...
print(f"Augmentation et équilibrage terminés. Chaque dossier contient {target_image_count} images.")
